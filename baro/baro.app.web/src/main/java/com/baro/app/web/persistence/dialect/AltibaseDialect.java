package com.baro.app.web.persistence.dialect;
...
public class AltibaseDialect extends Dialect {
	...
	protected void registerCharacterTypeMappings() {
		...
		registerColumnType(Types.VARCHAR, 32000, "varchar2($l)");
	...
	protected void registerNumericTypeMappings() {
		...
		registerColumnType(Types.DECIMAL, "number($p)");
	...
	public String getQuerySequencesString() {
		return " select table_name from system_.sys_tables_ where table_type='S'" + "  union" + " select synonym_name from system_.sys_synonyms_ where "
